...
7. Ask whether to publish to **Confluence** (via the `mcp-atlassian` MCP connector) — create a new page (defaults to `documentation.confluence_parent_id` as the parent folder) or update an existing one, attaching the generated file.
