---
description: Break the finalized scope into milestones, tagged ABAP/Fiori/mixed, checking for reuse in the SAP system.
---
...
5. Write the milestone plan to `.sdlc/state.json` (as the source of truth for `/vinsap:status`) and summarize it to the user.
6. Append an entry to `.sdlc/timeline.jsonl`.
